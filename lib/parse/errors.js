...
var exports = {
  ...
  InvalidCssQueryError: function(line, query){
    this.message = f('Invalid css query "%s" in spec %s on line %s', query, line.file, line.number);
  },
...
inherits(exports.InvalidCssQueryError, errors.ValidationError);
