...
function help(name){
  ...
  console.log([
    ...
    '',
    f('  Usage: %s [-h] [--version] [--variables <path>] [-v, --verbose] [--browsers <browsers>] [--cwd <path>] [-p <name>, --provider <name>] [-r <runner>], --run <runner>] [--worker-count <number>] [%s...]', name, GLOBS),
    '',
    SYNOPSIS,
    '',
    ...
    '',
    '  --cwd <path>',
    '    Change the working director to path.',
    '',
    '    Print this menu.',
    '',
    '  --version',
    ...
    '',
    '  -v, --verbose',
    '    Cause stderr and stdout of executed spun files to be output to the terminal.',
    '',
    '  --variables <path>',
    '    Use the referenced JSON object for default variable values within spun files.',
    '',
    '  -v, --verbose',
    '  --cwd dir',
